...
<?php //$this->load->view('package/backend/side_menu'); ?>
            <div class="content-page">
                        ...
                        <ul class="list-inline menu-left mb-0">
                            ...
                            <li>
                                <div class="page-title-box">
                                    <h4 class="page-title">Add / Edit Land Transfer</h4>
                                    <!--<ol class="breadcrumb">
						...
						<ul class="nav nav-tabs">                            
                            <li class="nav-item">
                                <a href="#profile" data-toggle="tab" aria-expanded="true" class="nav-link active">
                                   <i class="fa fa-file-text-o"></i> Land Transfer Data
                                </a>
                            </li>							
							...
							<li class="nav-item">
                                <a href="#route" data-toggle="tab" aria-expanded="false" class="nav-link">
                                   <i class="mdi mdi-account-settings-variant "></i> Land Transfer Detail
                                </a>
                            </li>
				...
				<div class="tab-pane" id="route">	
					...
					<div class="form-group row">
                        <label class="col-md-3 col-sm-12 col-form-label">Start Time</label>
                        <div class="col-md-4 col-sm-12">						
							
                            <select class="form-control" id="Start_h_time" name="Start_h_time">
					   ...
					   <div class="col-md-4 col-sm-12">							
                            ...
                            <select class="form-control" id="Start_m_time" name="Start_m_time">
							...
							<?php }	?><?php //if(($dataID !='') && ($listRoute2->begin_place_id == '1')){ echo "selected"; }?>
                                    ...
                                    <div class="form-group row">
                        <label class="col-md-3 col-sm-12 col-form-label">End Time</label>
                        <div class="col-md-4 col-sm-12">						
							
                            <select class="form-control" id="End_h_time" name="End_h_time">
                               <option value="0">-- Hour --</option>
							<?php for($a=1; $a<=24; $a++){ 
					   ...
					   <div class="col-md-4 col-sm-12">							
                            ...
                            <select class="form-control" id="End_m_time" name="End_m_time">
                               <option value="">-- Minute --</option>
							<?php for($x=0; $x<=59; $x++){ 
				...
				<option value="<?php echo $listTransport2->id?>"  ><?php echo $listTransport2->transport_name?></option>
									 <?php } ?> 
