   ...
   alert('Select atleast one records');
	...
	function delete_data(dataID,table){  
		...
		*/
        function searchinput(){
			...
			$.post('<?php echo base_url('PackageCMS/landTransfer_Search')?>' , { booking_status:booking_status , dataID:dataID,datebook:datepicker1, SearchBooking:SearchBooking,cfstatusno1:cfstatusno1 ,cfstatusno2:cfstatusno2,cfstatus:cfstatus } , function(data){ 
	...
	function updatecfstatus(dataID){ 
		...
		swal({
		   ...
		   $.post('<?php echo base_url('PackageCMS/updatecfstatus')?>' , { dataID : dataID ,cfstatus:cfstatus}, 
			function(data){
				if(data!='0'){ 
                	swal({
                    ...
                    setTimeout(function(){ window.location.href = "<?php echo base_url('PackageCMS/landTransfer_view')?>"; }, 2000);
				}else{
					swal({
	...
	function chBookStatus(textcf,dataID){  
		...
		swal({
           ...
           confirmButtonText: textcf
            ...
            if(textcf == 'Cancel'){
                textcontrol = 'updatecfstatus';
                cfstatus = '3';
            }else if(textcf == 'Save'){
                textcontrol = 'updatecfstatus';
                cfstatus = '2';
            }else if(textcf == 'Delete'){
                textcontrol = 'deleteland';
            }
