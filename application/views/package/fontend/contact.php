                       ...
                       <div class="col-sm-3">
                        ...
                        <div class="about-text">
                            ...
                            <div class="about-description">                                
								<p>For anyfurther information about our service, reservation, boat charter, schedule, or accommodation on Koh Lipe, please contact us at</p>

								<p style="padding: 5px 25px;  border-radius: 10px;  background-color: #aa986b5c;">Email: booking@akiraspeedboat.com</p>   
								<p style="padding: 5px 25px;  border-radius: 10px;  background-color: #aa986b5c;">Mobile: +66 (0) 98 161 6164 </p>                          
								<p style="padding: 5px 25px;  border-radius: 10px;  background-color: #aa986b5c;">Line: </p>
								<p style="padding: 5px 25px;  border-radius: 10px;  background-color: #aa986b5c;">Address: 370 Moo 7 Koh Lipe, Koh Sarai Sub-district,
Muang, Satun 91000 Thailand.</p>
                            </div>
                        </div>
						</div>
					</section>
